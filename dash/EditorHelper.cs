...
namespace Dash
{
    public class EditorHelper
    {
        ...
        public void SqfHighlight(FastColoredTextBox editor, TextChangedEventArgs e, bool forceRefresh = false)
        {
            ...
            range = forceRefresh ? editor.Range : e.ChangedRange;
        ...
        public void BuildAutocompleteMenu(AutocompleteMenu armaSense, bool forceUpdate = false)
        {
            ...
            var itemsCount = (snippets.Length + UserVariablesCurrentFile.Count + keywords.Length + 3);
            if(!forceUpdate)
            ...
            foreach (var item in keywords)
                items.Add(new AutocompleteItem(item) { ImageIndex = 0, ToolTipTitle = item, ToolTipText = item });
